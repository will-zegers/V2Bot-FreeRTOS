...
#define boardUART3	( const int8_t * const ) "/UART3/"
...
#define boardSPI_SSP_PORT							( const int8_t * const ) "/SSP1/"
#define board7SEG_CS_PORT							( 2 )
#define boardSPI_CS_PORT							( 2 )
#define boardOLED_CS_PORT							( 0 )
#define board7SEG_CS_PIN							( 1 << 11 )
#define boardSPI_CS_PIN								( 1 << 12 )
#define boardOLED_CS_PIN							( 1 << 6 )
#define board7SEG_DEASSERT_CS()						GPIO_SetValue( board7SEG_CS_PORT, board7SEG_CS_PIN )
#define boardSPI_DEASSERT_CS()						GPIO_SetValue( boardSPI_CS_PORT, boardSPI_CS_PIN )
...
#define boardSPI_ASSERT_CS()						GPIO_ClearValue( boardSPI_CS_PORT, boardSPI_CS_PIN )
